...
core.sectionNames = {
	...
	SL =  {
		name = "SL",
		category = {"Achievement", "Vendor", "Treasures", "Adventures", "Riddles", "Tormentors", "Maw Assaults", "Reputation", "Paragon Reputation", "Dungeon Drop", "Raid Drop", "Zone", "Daily Activities", "Rare Spawn", "Oozing Necroray Egg", "Covenant Feature", "Night Fae", "Kyrian", "Necrolords", "Venthyr"},
	},
	Horde = {
		name = "Horde",
	...
	Unobtainable = {
		name = "Unobtainable",
		category = {"Scroll of Resurrection", "Challenge Mode", "Recruit-A-Friend", "Ahead of the Curve", "Brawler's Guild", "Arena Mounts | TBC - WOD", "Arena Mounts | LEGION - SL", "Azeroth Choppers", "Original Epic Mounts", "Old Promotion Mounts", "Unobtainable Raid Mounts", "BrewFest"}
	}
}
core.mountList = {
	SL = {
